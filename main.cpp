      ...
      desplegarMenu();
        ...
        while(menu<0 || menu>4) {
          printf("Numero invalido, ingrese denuevo: ");
            scanf("%d", &menu);
        } // Ingresar hasta opcion valida;
        switch(menu) {
          case 1: // Registrar ingreso de un vehículo;
              if(hayLugar(est.arre)){
                ...
                printf("No hay lugar");
            break;
          case 2: // Registrar partida de un vehículo;
            valida=FALSE;
              printf("\nIngrese la matricula del vehiculo que quiere quitar: ");
                ...
                system("pause");
            break;
          case 3: // Menú de consultas y listados;
              do {
                  system("cls");
                  desplegarMenuOp3();
                    scanf("%d", &menu3);
                  while(menu3<0 || menu3>8) {
                      printf("Numero invalido, ingrese denuevo: ");
                        scanf("%d", &menu3);
                  } // Ingresar hasta opcion invalida
                  switch(menu3) {
                    case 1: // Total recaudado;
                        printf("\nEl total recaudado hasta el momento es: %d\n", darTotalRec(est));
                        printf("\n\n");
                        system("pause");
                      break;
                    case 2:  // Cantidad de autos y cantidad de camionetas;
                      int cantAutos, cantCamionetas;
                        ...
                        system("pause");
                      break;
                    case 3: // Cantidad de vehículos matriculados en un departamento determinado;
                      dptoMatri d;
                        cargaDpto(d);
                        ...
                        system("pause");
                      break;
                    case 4: // Listado de vehículos registrados actualmente;
                        ...
                        system("pause");
                      break;
                    case 5: // Listado detallado de un vehículo;
                      string matr;
                        ...
                        system("pause");
                      break;
                    case 6: // Listado de vehículos que ingresaron dentro de una hora determinada;
                      int h;
                        printf("\nIngrese hora (solo hora): ");
                          scanf("%d", &h);
                        ingresadosXHora(est.arre, h);
                        printf("\n\n");
                        system("pause");
                      break;
                    case 7: // Listado de camionetas que superan una capacidad de carga determinada;
                      int capC;
